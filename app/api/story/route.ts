...
export async function POST(req:Request){
  try{
    ...
    const events=length==='4–5 minutes'?'110-135':length==='2–3 minutes'?'80-105':length==='90 seconds'?'48-60':'28-38';
